...
namespace Simple.Data
{
    public class SimpleDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseNpgsql(@"Database=simpledb; Server=pgserver123456789.postgres.database.azure.com; User Id=myadmin@pgserver123456789; Password=123pG!321; Ssl Mode=Require;");
        }
    }
}
